drawing_simulation_west_WuhanNPI=function(country1,country2,country3,country4,country5,country6,original_trajectory){
  ...
  for (ii in 1:6){
    ...
    plot(date_rangeB,a1[1,,13,country],pch=19,ylim=c(0,pmax(#max(a16all_noaction_China[1,]-c(0,head(a16all_noaction_China[1,],-1))),
      ...
      # max(a16China_nosocial_distancing[1,,13,ii]),
      #  max(a16China_noisolation[1,,13,ii]),
      #max(a16China_noshutdown[1,,13,ii]))
      max(a1[1,,13,country]))*1.02)
    ...
    lines(date_rangeB,a1[1,,13,country],type="l",col=rgb(1,0,0,1),xaxt="n",yaxt="n",xlab="",ylab="299",cex=2)
    ...
    #lines(date_rangeB,a12[1,,13,ii],type="l",col=rgb(0.1,0.2,0.1,1),xaxt="n",yaxt="n",xlab="",ylab="299+105",cex=2)
    #lines(date_rangeB,a13[1,,13,ii],type="l",col=rgb(0.1,0.2,0.1,0.6),xaxt="n",yaxt="n",xlab="",ylab="299+90",cex=2)
    #lines(date_rangeB,a14[1,,13,ii],type="l",col=rgb(0.1,0.2,0.1,0.5),xaxt="n",yaxt="n",xlab="",ylab="299+75",cex=2)
    #lines(date_rangeB,a15[1,,13,ii],type="l",col=rgb(0.1,0.2,0.1,0.4),xaxt="n",yaxt="n",xlab="",ylab="299+60",cex=2)
    #lines(date_rangeB,a16[1,,13,ii],type="l",col=rgb(0.1,0.2,0.1,0.3),xaxt="n",yaxt="n",xlab="",ylab="299+45",cex=2)
    ...
    if(original_trajectory==TRUE){
      points(date_rangeC,confirmation[1:144,country],cex=0.85,pch=1,col="black")}
  }
}
