drawing_intervention_comparison_under_reporting=function(){
  start_date=as.Date("2020-1-23")
  end_date=as.Date("2020-6-26")
  date_rangeB <- seq(start_date,end_date,1)
  
  S_plot=yousee210.130under_reporting[[1]]
  I_plot=yousee210.130under_reporting[[2]]
  II_plot=yousee210.130under_reporting[[3]]
  E_plot=yousee210.130under_reporting[[4]]
  Rec_plot=yousee210.130under_reporting[[5]]
  Die_plot=yousee210.130under_reporting[[6]]
  C_plot=yousee210.130under_reporting[[7]]
  Rep_plot=yousee210.130under_reporting[[8]]
  R0_plot=yousee210.130under_reporting[[9]]
  Rec_all_plot=yousee210.130under_reporting[[10]]
  Die_all_plot=yousee210.130under_reporting[[11]]
  C_all_plot=yousee210.130under_reporting[[12]]
  Iso_all_plot=yousee210.130under_reporting[[13]]
  Rep_all_plot=yousee210.130under_reporting[[14]]
  For_plot=yousee210.130under_reporting[[15]]
  sus_rate_plot=yousee210.130under_reporting[[16]]
  track_rate_plot=yousee210.130under_reporting[[17]]
  iso_rate_plot=yousee210.130under_reporting[[18]]
  home_rate_plot=yousee210.130under_reporting[[19]]
  inhome_plot=yousee210.130under_reporting[[20]]
  ...
  start_date <- as.Date("2020-01-23") # first case
  ...
  layout(matrix(c(1,1,1,2,3,4,5,6,7,8,8,8),4, 3, byrow = T),heights=c(1,5,5,5))
